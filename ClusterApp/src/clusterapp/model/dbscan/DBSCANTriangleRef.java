...
import clusterapp.model.nbc.Point;

import triangle.*;
import util.Distance;


public class DBSCANTriangleRef extends DBSCANTriangle {

    // System variables
    public static final String NAME = "TI_DBSCAN_REF";

    ArrayList<Point> RefPoints = new ArrayList<Point>();

    public String getName() {
        return DBSCANTriangleRef.NAME;
    }
    ...
    public void createRefPoints() {
        ...
        // Wartoœæ atrybutu w danym wymiarze: maksymalna, pozosta³e wartoœci
        // atrybutów: minimalne.
...
//                Point point = new Point(co.getSpatialObject().getCoordinates().clone());
//                if (j == 0) {
...
//            Point p = new Point(ob.getSpatialObject().getCoordinates().clone());
//            RefPoints.add(p);
//        }
