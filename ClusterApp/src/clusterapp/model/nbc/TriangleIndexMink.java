...
public class TriangleIndexMink extends LoggingIndex implements lvaindex.vafile.ISpatialIndex {
	 ...
	 * @param k
	 */
	public TriangleIndexMink(int k, int m) {
	    TI_k_Neighborhood_Index(D, k, m);
	}
	...
	public void TI_k_Neighborhood_Index(ArrayList<ISpatialObject> D, int k, int m) {
		this.k = k;
		this.m = m;
	...
	//        dist2 = Distance2(b, p);
	            double dist2 = Distance.DistanceM2(b[0], p, m);
	...
	//        dist2 = Distance2(f, p);
	            double dist2 = Distance.DistanceM2(f[0], p, m);
	...
	//  var point f, var forwardSearch, var k-Neighborhood, var Eps2)
        ...
        public void createSortedTableD(Collection<ISpatialObject> input,
            ...
            for (ISpatialObject o : input) {
                ...
                double distanceM = Distance.DistanceM2(refPoint, point, m);
                double distance = Distance.sqrtMink(distanceM, m);

                point.dist2 = distanceM;
                point.dist = distance;
