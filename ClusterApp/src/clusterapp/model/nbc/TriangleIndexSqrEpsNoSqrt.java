...
public class TriangleIndexSqrEpsNoSqrt extends LoggingIndex implements lvaindex.vafile.ISpatialIndex {
     ...
     * @param k
     */
    public TriangleIndexSqrEpsNoSqrt(int k) {
    ...
    public void Verify_k_Candidate_Neighbours_Backward(
        ...
        while (backwardSearch == 1 && (Math.pow(p.dist - b[0].dist, 2) <= p.Eps2)) {
            double dist2 = Distance.Distance2(b[0], p);
            if (dist2 < p.Eps2) {
